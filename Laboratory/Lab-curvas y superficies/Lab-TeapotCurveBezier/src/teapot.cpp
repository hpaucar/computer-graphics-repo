...
void onIdle(GLFWwindow* window, double currentTime) {
  float angle = currentTime / 1.0 * glm::radians(15.0);  // 15° per second
  glm::mat4 anim =
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(screen_width, screen_height, "Lab: Draw Bezier Curve with TeaPot", NULL, NULL);
