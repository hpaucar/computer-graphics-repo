...
int main( void )
{
	...
	GLuint programID = LoadShaders( "src/NormalMapping.vertexshader", "src/NormalMapping.fragmentshader" );
	...
	// Load the texture
	GLuint DiffuseTexture = loadDDS("src/diffuse.DDS");
	GLuint NormalTexture = loadBMP_custom("src/normal.bmp");
	GLuint SpecularTexture = loadDDS("src/specular.DDS");
	...
	bool res = loadOBJ("src/cylinder.obj", vertices, uvs, normals);
