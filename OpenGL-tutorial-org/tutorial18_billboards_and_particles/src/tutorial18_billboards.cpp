...
int main( void )
{
	...
	GLuint programID = LoadShaders( "src/Billboard.vertexshader", "src/Billboard.fragmentshader" );
	...
	GLuint Texture = loadDDS("src/ExampleBillboard.DDS");
	...
	GLuint cubeProgramID = LoadShaders( "src/TransformVertexShader.vertexshader", "src/ColorFragmentShader.fragmentshader" );
