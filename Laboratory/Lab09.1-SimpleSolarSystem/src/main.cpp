//============================================================================
// Name        : Display Simple Solar System
...
void display(GLFWwindow *window, double currentTime) {
	...
	mLoc = glGetUniformLocation(renderingProgram, "mv_matrix");
...
int main(void) {
	...
	GLFWwindow *window = glfwCreateWindow(800, 800, "Lab 09: Display Simple Solar System", NULL, NULL);
